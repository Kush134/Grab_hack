...
# agents/crypto_economics/crypto_economics.py
from fin.base_agent import BaseAgent

class CryptoEconomics(BaseAgent):
    def __init__(self):
        super().__init__(
            name="Crypto Economics Specialist",
            description="expert in tokenomics, crypto inflation models, and staking rewards"
        )
    ...
    def get_capabilities(self) -> list[str]:
        return ["crypto", "tokenomics", "inflation", "staking", "token"]