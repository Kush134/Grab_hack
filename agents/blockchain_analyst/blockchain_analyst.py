...
# agents/blockchain_analyst/blockchain_analyst.py
from fin.base_agent import BaseAgent
...
class BlockchainAnalyst(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="expert in analyzing on-chain data, transactions, and smart contracts"
        )
    ...
    def get_capabilities(self) -> list[str]:
        return ["blockchain", "transaction", "on-chain", "hash", "smart contract"]