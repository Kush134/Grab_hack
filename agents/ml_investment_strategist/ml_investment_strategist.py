...
# agents/ml_investment_strategist/ml_investment_strategist.py
from fin.base_agent import BaseAgent
...
class MLInvestmentStrategist(BaseAgent):
    def __init__(self):
        super().__init__(
            name="ML Investment Strategist",
            description="expert in using machine learning for stock market prediction and investment strategies"
        )

    @classmethod
    def get_agent_name(cls):
        return "MLInvestmentStrategist"

    def get_capabilities(self) -> list[str]:
        return ["investment", "machine learning", "ml", "predict", "stock", "portfolio"]