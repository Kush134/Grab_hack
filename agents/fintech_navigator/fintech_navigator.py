...
# fintech_navigator.py
# agents/fintech_navigator/fintech_navigator.py
...
class FinTechNavigator(BaseAgent):
    def __init__(self):
        super().__init__(
            name="Fintech Navigator",
            description="general expert in financial technology, including payments, digital banking, and insurtech"
        )

    @classmethod
    def get_agent_name(cls):
        return "FinTechNavigator"

    def get_capabilities(self) -> list[str]:
        return ["fintech", "payment", "digital bank", "insurtech"]