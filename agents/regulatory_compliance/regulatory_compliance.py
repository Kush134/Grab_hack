...
# agents/regulatory_compliance/regulatory_compliance.py
from fin.base_agent import BaseAgent
...
class RegulatoryCompliance(BaseAgent):
    def __init__(self):
        super().__init__(
            ...
            description="expert in financial regulations, including KYC, AML, and SEC guidelines"
        )
    ...
    def get_capabilities(self) -> list[str]:
        return ["regulation", "compliance", "sec", "kyc", "aml", "law"]