...
def main():
    """
    Main function to run the command-line interface for the Fintech Multi-Agent System.
    """
    print("🤖 Welcome to the Fintech Multi-Agent System!")
    print("Ask a question, and the right agent will respond. Type 'exit' to quit.")
    ...
    while True:
        ...
        print(f"\nSelecting agent: {selected_agent.name}...")
        # Get the response from the agent (which now uses GPT-4o)
